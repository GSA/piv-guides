...
| Encryption               |Sometimes      | Key Encipherment            | _Specific EKU are required for certificates issued after June 2019_            |  rfc822name = email address |  Email address is **not** required by policy. Encryption certificates that represent available, retired encryption key pairs may exist, depending on the PIV issuer. 
