...
To use SSH for remote access to a UNIX-like server, you need to first authenticate your PIV/CAC. PIV/CAC authentication and SSH can be done from a Windows, Linux, or 
-based computer. For remote access, you also need to configure the UNIX-like server.
